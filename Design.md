...
These don't seem like a good fit - they are generally precise but will not be able to gather temperature from fluid touching the housing - a sensor that can be pressed onto the exterior wall of the sensor housing seems like a better fit
